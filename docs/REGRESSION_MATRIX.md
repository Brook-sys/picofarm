...
| Notifications | Customer/operator communication | Template rendering, delivery recording, and multipart media tests | Preview/test delivery; for print lifecycle events verify the G-code thumbnail and caption arrive as one Telegram/Discord message |
