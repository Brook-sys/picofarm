...
| Etsy/Squarespace sync | External source of orders/listings | Client conversion tests and fake API tests | Sync with sandbox/mock only; do not require credentials |
