...
| Product links | In MVP after product sync. Reuse generic product link routes. | Enabled for Shopee products/variants present in canonical storage. | Generic link/unlink tests cover Shopee product variants, project/SKU mapping, linked filtering, and `raw_json` omission from public responses. |
