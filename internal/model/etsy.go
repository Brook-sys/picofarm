...
// EtsyListingProject links an Etsy listing to a project.
type EtsyListingProject struct {
	ID            int64     `json:"id"`
	EtsyListingID int64     `json:"etsy_listing_id"`
...
// EtsyListingTemplate is a legacy alias for EtsyListingProject.
type EtsyListingTemplate = EtsyListingProject
